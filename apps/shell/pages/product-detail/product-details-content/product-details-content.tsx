...
function ProductDetailsContent({ product, relatedProducts, className, categoryCode }: Props) {
	return (
		<div className={cx(styles.productDetailsContent, className)}>
			<ProductImagesCarousel key={`${product.code}_carousel`} product={product} />
			{
			...
			<ProductSpecs specs={product.specs} />
			{
				...
				<ProductRelatedProducts relatedProducts={relatedProducts} categoryCode={categoryCode} />
			}
		</div>
	);
}
