...
function ImagesSelector({ imagesUrls, onImageSelected, productName, selectedImageIndex }: Props) {
	return (
		<nav className={styles.imagesSelector}>
			<ul className={styles.imagesContainer}>
				{imagesUrls.map((url, index) => (
					<li
						key={url}
						className={cx(styles.imageItem, { [styles.imageItem_selected]: selectedImageIndex === index })}
