	...
	return (
		<section className={cx(styles.productDetailsSidebar, className)}>
			...
			<AlertBanner className={utilStyles.marginTop_20}>
				<p>Christmas shopping? Check the latest delivery info in check-out to ensure you get it before Christmas.</p>
			</AlertBanner>
			<div className={styles.productActions}>
				...
				>Add to bag</Button>
				<IconButton className={cx({ [styles.wishlistIconSelected]: isWishlistedProduct })} onClick={_onAddToFavorites}>
					<FavoriteIcon />
				</IconButton>
			</div>
		</section>
