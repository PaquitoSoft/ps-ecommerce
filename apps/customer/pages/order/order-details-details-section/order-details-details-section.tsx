	...
	return (
		<div>
			...
			<div className={styles.orderDetailsDetailsContainer}>
				<div>
					<h3 className={styles.orderDetailsOrderNumberTitle}>Order number</h3>
					<p>{order.code}</p>
					<p><FormattedDate timestamp={order.placedDate} /></p>
				</div>
				<div className={styles.orderDetailsPayment}>
					<h3 className={styles.orderDetailsOrderNumberTitle}>Payment</h3>
