...
export const getServerSideProps: GetServerSideProps = async (context) => {
	...
	const [productQueryData, relatedProductsQueryData] = await Promise.all(
		dataPromises
	);
	...
	return {
		props: {
			...
			relatedProducts: relatedProductsQueryData
				? relatedProductsQueryData.data.productsByCategory.products
				: null,
		},
	};
};
